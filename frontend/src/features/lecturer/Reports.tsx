...
const Reports = () => {
  ...
  const stats = {
    ...
    // ✅ Average rate = average of (present / totalStudents) per session
    avgRate:
      history.length > 0
        ? Math.round(
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl p-8">
            ...
            >
              ...
              {(() => {
                // ✅ Use totalStudents as denominator
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-slate-600 text-slate-400 text-xs uppercase bg-slate-800/50">
              <th className="text-left p-3 font-medium w-12 text-sm">#</th>
              <th className="text-left p-3 font-medium w-1/3">Report</th>
              <th className="text-left p-3 font-medium w-1/6">Present/Total</th>
              <th className="text-left p-3 font-medium w-1/6">Rate</th>
              <th className="text-left p-3 font-medium w-1/6">Download</th>
