...
const LiveSession = () => {
  ...
  return (
    <div className="space-y-2 md:space-y-6 max-w-6xl mx-auto">
      {/* Header */}
      <div className="flex flex-col gap-2 md:gap-4 bg-slate-700 border border-slate-600 rounded-lg md:rounded-2xl p-3 md:p-6 shadow-sm lg:flex-row lg:items-center lg:justify-between">
        <div className="min-w-0">
          ...
          <p className="text-[10px] md:text-sm text-slate-400 truncate mt-0.5">
            Code: {session.unit?.code} • Radius: {session.radius}m
          </p>
        </div>
        <div className="flex items-center gap-2 md:gap-3 flex-wrap">
          <div className="bg-slate-600 border border-slate-500 rounded-md md:rounded-xl px-2.5 md:px-5 py-1.5 md:py-3 text-center min-w-[70px] md:min-w-[100px]">
            <p className="text-[9px] md:text-xs text-slate-400 uppercase leading-tight">
              Left
            </p>
            <p
              className={`text-sm md:text-xl font-mono font-bold leading-tight ${
          ...
          <button
            onClick={copyLink}
            className="px-3 md:px-4 py-2 md:py-2.5 bg-slate-600 text-emerald-400 border border-slate-500 rounded-md md:rounded-lg text-[10px] md:text-sm font-medium hover:bg-slate-500 transition whitespace-nowrap"
          >
            Copy
          </button>
          <button
            onClick={end}
            className="px-3 md:px-4 py-2 md:py-2.5 bg-rose-900/20 text-rose-400 border border-rose-800 rounded-md md:rounded-lg text-[10px] md:text-sm font-medium hover:bg-rose-900/40 transition whitespace-nowrap"
          >
            End
          </button>
        </div>
